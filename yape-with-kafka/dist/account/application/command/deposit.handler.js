...
const deposit_command_1 = require("./deposit.command");
const injection_token_1 = require("../injection.token");
const error_1 = require("../../domain/error");
let DepositHandler = class DepositHandler {
...
DepositHandler = __decorate([
    (0, cqrs_1.CommandHandler)(deposit_command_1.DepositCommand),
