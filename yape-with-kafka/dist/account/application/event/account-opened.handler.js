...
exports.AccountOpenedHandler = void 0;
const common_1 = require("@nestjs/common");
const cqrs_1 = require("@nestjs/cqrs");
const integration_1 = require("./integration");
const injection_token_1 = require("../injection.token");
const account_opened_event_1 = require("../../domain/event/account-opened.event");
let AccountOpenedHandler = class AccountOpenedHandler {
    ...
    async handle(event) {
        this.logger.log(`${integration_1.IntegrationEventSubject.OPENED}: ${JSON.stringify(event)}`);
        await this.publisher.publish({
            subject: integration_1.IntegrationEventSubject.OPENED,
            data: { id: event.id },
        });
...
AccountOpenedHandler = __decorate([
    (0, cqrs_1.EventsHandler)(account_opened_event_1.AccountOpenedEvent),
...
//# sourceMappingURL=account-opened.handler.js.map